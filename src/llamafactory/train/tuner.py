...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: List["TrainerCallback"] = []) -> None:
    ...
    elif finetuning_args.stage == "ttl":
        run_ttl(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
    elif finetuning_args.stage == "vl_ttl":
        run_vl_ttl(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
