...
import torch
# from peft import PeftModel  # Commented out to avoid circular import
...
if TYPE_CHECKING:
    ...
    # from peft import LoraModel  # Commented out to avoid circular import
...
def check_lora_model(model: "torch.nn.Module") -> Tuple[Set[str], Set[str]]:
...
def load_reference_model(
    ...
    if use_lora or use_pissa:
        # Import peft here to avoid circular import
        try:
