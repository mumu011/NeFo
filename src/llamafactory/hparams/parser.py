...
def get_train_args(args: Optional[Dict[str, Any]] = None) -> _TRAIN_CLS:
    ...
    if finetuning_args.stage != "sft" and finetuning_args.stage != "ttl" and finetuning_args.stage != "vl_ttl":
        if training_args.predict_with_generate:
            raise ValueError("`predict_with_generate` cannot be set as True except SFT, TTL and VL_TTL.")
    ...
    if (training_args.do_eval or training_args.do_predict) and (
        ...
        print(training_args.do_eval, training_args.do_predict)
