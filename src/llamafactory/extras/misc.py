...
def check_dependencies() -> None:
    ...
    if os.getenv("DISABLE_VERSION_CHECK", "0").lower() in ["true", "1"]:
        ...
        require_version("transformers>=4.35.0,<=4.57.1", "To fix: pip install transformers>=4.35.0,<=4.57.1")
        require_version("datasets>=2.14.7,<=3.1.0", "To fix: pip install datasets>=2.14.7,<=3.1.0")
        require_version("accelerate>=0.32.1,<=1.11.0", "To fix: pip install accelerate>=0.32.1,<=1.11.0")
        require_version("peft>=0.11.1,<=0.17.1", "To fix: pip install peft>=0.11.1,<=0.17.1")
